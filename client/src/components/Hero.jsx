  ...
  return (
    <div className='h-[100vh] bg-gradient-to-b from-PopYellow to-KindaWhite w-full flex items-center justify-center'>
      <div className='flex flex-col items-center'>
        ...
        <button className='h-10 border-2 text-KindaWhite border-GreenBrown bg-gradient-to-b from-GreenBrown to-FakeBlack px-5 rounded-xl flex items-center justify-center space-x-2 hover:scale-105 duration-300 font-semibold '>Explore</button>
      </div>
    </div>
  )
}
