...
const Available = () => {
  ...
  return (
    <div className="w-[80%] mx-auto h-[100vh] flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-[100px] justify-center">
        {quizzes.map(quiz => (
          <div key={quiz.quiz_id} className="border-transparent border-2 rounded-md w-[300px] h-[200px] flex flex-col items-center">
            ...
            <button className='bg-PopYellow px-4 py-1 border-GreenBrown border-2 rounded-md my-5' onClick={() => handleClick(quiz.quiz_id)}>Attend</button>
          </div>            
        ))}
      </div>
    </div>
